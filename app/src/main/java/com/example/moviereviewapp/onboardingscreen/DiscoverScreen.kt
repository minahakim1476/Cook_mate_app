...
@Composable
fun DiscoverScreen(navController: NavController, modifier: Modifier = Modifier) {
    Column(
        modifier = modifier
            .fillMaxSize()
        ...
        Text(
            text = stringResource(R.string.discover_daily_recipes),
            modifier = Modifier
                .padding(top = 16.dp),
            fontSize = 24.sp,
        ...
        Text(
            text = stringResource(R.string.discover_screen_text),
            modifier = Modifier
                .padding(top = 16.dp),
            fontSize = 16.sp,
            color = Color.Gray,
